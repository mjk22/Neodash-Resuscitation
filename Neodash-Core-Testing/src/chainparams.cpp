...
{
    const char* pszTimestamp = "NeoDash start 8.12.17";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1512689834, 710910, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000086bfc6557edfe2ccec9d702ffa01819bf015f80582e09a964e2dfcb08e"));
        assert(genesis.hashMerkleRoot == uint256S("0x6477f64d1e7e6015fbbbb0fc6d76dbd9148c924b7de0207727a58704c6bc2cf1"));


        vSeeds.push_back(CDNSSeedData("35.227.30.194", "35.227.30.194"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  30, uint256S("0x000004c842dff3d489fc1f8f26254b469e4774a7a55cf1ca1cc865a593246ad8")),
            1512701620, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x00000086bfc6557edfe2ccec9d702ffa01819bf015f80582e09a964e2dfcb08e")),

            1512689834, // * UNIX timestamp of last checkpoint block
            0,      // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
