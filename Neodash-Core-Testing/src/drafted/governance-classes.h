 ...
 *
 *   // network
 *   CNeodashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CNeodashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CNeodashNetwork(UniValue objIn)
    {
...
// // can be under: NeodashNetwork
// //   -- signature requirements : Key1(User)
// class CNeodashNetworkVariable : public CGovernanceObject
// {
// private:
