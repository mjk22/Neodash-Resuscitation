...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NeodashNetwork") type = NeodashNetwork;
    if(strType == "NeodashNetworkVariable") type = NeodashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NeodashNetwork) s = "NeodashNetwork";
    if(type == NeodashNetworkVariable) s = "NeodashNetworkVariable";
