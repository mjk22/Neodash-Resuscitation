    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Neodash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Neodash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and neodash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Neodash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Neodash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Neodash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Neodash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Neodash addresses"));
    ...
    openAction->setStatusTip(tr("Open a neodash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Neodash Core help message to get a list with possible Neodash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Neodash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Neodash network", "", count));
}
...
{
    QString strTitle = tr("Neodash Core"); // default title
