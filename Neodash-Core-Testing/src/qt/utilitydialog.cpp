    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Neodash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Neodash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  neodash-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Neodash Core is shutting down...") + "<br /><br />" +
