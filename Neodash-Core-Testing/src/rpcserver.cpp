...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Neodash server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Neodash features */
    { "neodash",               "masternode",             &masternode,             true  },
    { "neodash",               "masternodelist",         &masternodelist,         true  },
    { "neodash",               "masternodebroadcast",    &masternodebroadcast,    true  },
    { "neodash",               "mngovernance",           &mngovernance,           true  },
    { "neodash",               "voteraw",                &voteraw,                true  },
    { "neodash",               "mnsync",                 &mnsync,                 true  },
    { "neodash",               "spork",                  &spork,                  true  },
    { "neodash",               "getpoolinfo",            &getpoolinfo,            true  },
#ifdef ENABLE_WALLET
    { "neodash",               "privatesend",            &privatesend,            false },
...
{
    return "> neodash-cli " + methodname + " " + args + "\n";
}
