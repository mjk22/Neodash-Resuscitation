...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:7135", "127.0.0.1", 7135));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7135", "127.0.0.1", 7135));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7135", "::ffff:127.0.0.1", 7135));
    BOOST_CHECK(TestSplitHost("[::]:9999", "::", 7135));
    BOOST_CHECK(TestSplitHost("::7135", "::7135", -1));
    BOOST_CHECK(TestSplitHost(":7135", "", 7135));
    BOOST_CHECK(TestSplitHost("[]:7135", "", 7135));
