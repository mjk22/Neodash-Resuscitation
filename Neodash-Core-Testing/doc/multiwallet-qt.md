...
Only requiring some minor changes is neodash.cpp.
...
Changes to neodash.cpp
----------------------
neodash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
