...
This document provides guidelines for internationalization of the Neodash Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Neodash network</numerusform>
            <numerusform>%n active connections to Neodash network</numerusform>
        </translation>
    </message>
